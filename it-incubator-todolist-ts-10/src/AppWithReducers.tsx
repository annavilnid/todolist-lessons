...
import {addTaskAC, changeTaskStatusAC, changeTaskTitleAC, removeTaskAC, tasksReducer, ActionsTasksType} from "./state/tasks-reducer";
import {
  addTodolistAC,
...
function AppWithRedusers() {
  ...
  let [todolists, dispatchToTodolists] = useReducer<Reducer<Array<TodolistType>, ActionsTodolistsType>>(todolistsReducer, [
